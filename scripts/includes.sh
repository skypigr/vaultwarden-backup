...
function init_env_gpg() {
    ...
    # GPG_SIGNING_PASSPHRASE_FILE (preferred; do not load passphrase content here)
    get_env GPG_SIGNING_PASSPHRASE_FILE
    GPG_SIGNING_PASSPHRASE_FILE="${GPG_SIGNING_PASSPHRASE_FILE:-""}"
